        ...
        <div className="login-form-style">
            <Zoom>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <button type="submit" className="btn btn-primary form-control">{newUser ? 'Sign Up' : 'Login'}</button>
                </form>
                ...
                <div>
                    ...
                    <button type="button" onClick={handleGoogleSignIn} className="btn btn-outline-primary form-control"><FontAwesomeIcon icon={faGooglePlusG} /> Continue with Google</button>
                </div>
            </Zoom>
        </div>
    );
