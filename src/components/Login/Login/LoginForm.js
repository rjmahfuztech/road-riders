    ...
    return (
        ...
        <div className="login-form-style">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <button type="submit" className="form-control btn btn-primary">{newUser ? 'Sign Up' : 'Login'}</button>
            </form>
            ...
            <div>
                ...
                <button onClick={handleGoogleSignIn} className="form-control btn btn-outline-primary"><FontAwesomeIcon icon={faGooglePlusG} /> Continue with Google</button>
            </div>
        </div>
        </Zoom>
    );
