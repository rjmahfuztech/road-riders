        ...
        <div className="row d-flex align-items-center">
          ...
          <div className="col-md-6 col-12">
            ...
            <p className="text-secondary mt-4">
              ...
              quis repellat eum aliquam vel, fuga ex doloribus repudiandae
              temporibus eligendi mollitia accusamus quam saepe dolores cumque
              odit, adipisci laboriosam eos rerum nemo fugiat, dolore veritatis
              quasi accusantium. Ducimus, exercitationem fugit!
            </p>
